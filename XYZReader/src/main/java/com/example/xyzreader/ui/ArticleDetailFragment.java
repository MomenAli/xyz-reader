...
public class ArticleDetailFragment extends Fragment implements
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        rosario = Typeface.createFromAsset(getActivity().getAssets(),"Rosario-Regular.ttf");
        Log.d(TAG, "onCreate: " + (rosario == null));
        Log.d(TAG, "onCreate: " + (articleBody == null));

        articleBody.setTypeface(rosario);
        articleByLine.setTypeface(rosario);
        articleTitle.setTypeface(rosario);
